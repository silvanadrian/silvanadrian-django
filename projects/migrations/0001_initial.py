...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('square_image', self.gf('django.db.models.fields.files.ImageField')(default='media/img/about.png', max_length=100)),
            ('wide_image', self.gf('django.db.models.fields.files.ImageField')(default='media/img/about.png', max_length=100, blank=True)),
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customers', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'customers'", 'to': u"orm['auth.User']"}),
            ...
            'square_image': ('django.db.models.fields.files.ImageField', [], {'default': "'media/img/about.png'", 'max_length': '100'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'wide_image': ('django.db.models.fields.files.ImageField', [], {'default': "'media/img/about.png'", 'max_length': '100', 'blank': 'True'})
        },
        u'projects.update': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'Update'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
