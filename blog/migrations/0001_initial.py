...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_post', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blogposts', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blogposts'", 'to': u"orm['auth.User']"}),
